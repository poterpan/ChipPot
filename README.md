...
![Vitest](https://img.shields.io/badge/tests-287%20passing-0f6e63?logo=vitest&logoColor=white)
...
- 🧪 **Real-runtime tests** — 287 Vitest cases run against actual Miniflare D1 + R2 (FK constraints
  enforced), not mocks.
